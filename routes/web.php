...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('/admin/usuarios', [AdminUserController::class, 'index'])->name('admin.index');
    Route::post('/notificaciones/marcar-leidas', [NotificacionController::class, 'markAllRead'])->name('notifications.markAllRead');
